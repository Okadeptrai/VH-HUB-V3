...
ImageButton.Image = "rbxassetid://15388425623"
...
local serv = win:Server("Min XT Hub","")
...
AutoFarm:Button("TP to Island Farm Level",function()
	BTP(CFrameMon)
end)
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.Auto_Cake_Prince or _G.AutoFarmBoss then
...
------------------------------
	AutoFarm:Button("TP to Cake Island",function()
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
					BoSs:Refresh("Status : Spawn")	
				else
					BoSs:Refresh("Status : Boss Not Spawn")	
				end
			end)
		end
	end)
...
elseif Three_World then
    ...
    AutoFarm:Dropdown("Select Boss",tableBoss,function(value)
        _G.SelectBoss = value
    end)
    
    AutoFarm:Toggle("Auto Farm Boss",_G.AutoFarmBoss,function(value)
...
AutoFarm:Button("TP to Bone Island",function()
...
local RaceV4 = serv:Channel("RaceV4", "http://www.roblox.com/asset/?id=7040391851")
    ...
    RaceV4:Button("Teleport To Top Of Great Tree",function()
        TP(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
          end)
          
          RaceV4:Button("Teleport Time Room",function()
      ...
      RaceV4:Button("Teleport To Red Soul",function()
      ...
      RaceV4:Button("Auto Complete Angel Trial",function(t)
          ...
          RaceV4:Toggle("Kill Player When Trial",false,function(Val)
              _G.AutoKillTial = Val
